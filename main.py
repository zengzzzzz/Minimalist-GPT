...
import minmalist_gpt # Our own BabyGPT in babygpt.py
...
vocab_size = 2
context_length = 3
config = minmalist_gpt.GPTConfig(
...
print("Creating new minmalist_gpt ...")
gpt = minmalist_gpt.GPT(config)
